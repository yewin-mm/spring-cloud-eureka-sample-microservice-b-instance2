package pers.yewin.eurekasamplemicroserviceb;
...
public class EurekaSampleMicroserviceBApplication {

    public static void main(String[] args) {
        SpringApplication.run(EurekaSampleMicroserviceBApplication.class, args);
    }
